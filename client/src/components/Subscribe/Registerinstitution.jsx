...
function RegisterInstitution({ setDisplay }) {
  async function handleSubmit(e) {
    ...
    fetch("https://delegate-x-backend.vercel.app/v1/registerinstitution", {
      method: "POST",
      ...
      .then((response) => {
        if (response.stored) alert("institution stored");
        else alert("institution not stored: " + response.error);
      });
  }
        ...
        <u>
          <b>
            <label>
              ...
              <br /> it will be bounded to the institution
            </label>
          </b>
        </u>
        <br />
